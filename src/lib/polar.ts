import { PolarCustomer, PolarOrder, PolarPrice, PolarProduct, PolarSubscription } from "@/types/polar"

export const extractSubsriptionLike = (data: unknown): PolarSubscription | null => {
    if (data && typeof data === "object") {
        ...
        if (typeof id === "string" && typeof status === "string") {
            return {
                ...
                customer: sub.customer as PolarCustomer | null,
                ...
                planCode: sub.planCode as string | undefined | null,
...
export const extractOrderLike = (data: unknown): PolarOrder | null => {
    ...
    return {
        ...
        customer: d.customer as PolarCustomer | null,
