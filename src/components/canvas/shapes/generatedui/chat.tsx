...
const ChatWindow = ({isOpen, onClose, generatedUUID}: Props) => {
    const {
        inputValue,
        setInputValue, 
        scrollAreaRef,
        ...
        handleClearChat,
        chatState
    } = useChatWindow(generatedUUID, isOpen)
  ...
  return (
    <div className={cn(
        ...
        <div className='flex flex-col items-center justify-between p-4 border-b border-white/12'>
            <div className='flex items-center gap-2'>
                ...
                <div className='flex items-center gap-1'>
                    {chatState?.messages && chatState.messages.length > 0 && (
                        <Button value={"ghost"} size="sm" onClick={handleClearChat} 
            ...
            <div className='p-4 border-t border-white/12'>
                <div className='space-y-3'>
                    <div className='flex gap-2'>
                        ...
                        size={"sm"} className='bg-blue-500 hover:bg-blue-600 text-white'>
